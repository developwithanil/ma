...
const courses: Course[] = [
  {
    ...
    title: "Justice & Compliance",
    units: "28 Units",
    description: "Make better decisions with AI-powered compliance workflows.",
  },
  {
    image: "/images/automate.png",
    title: "Automation & Workflows",
    units: "23 Units",
    description: "Build AI workflows that reduce manual effort and speed up execution.",
  },
  {
    image: "/images/business.png",
    title: "AI for Business Strategy",
    units: "21 Units",
    description: "Understand where AI fits into your business and how to create a clear roadmap for implementation.",
  },
  {
    image: "/images/marketing.png",
    title: "Marketing & Growth with AI",
    units: "25 Units",
    description: "Launch AI-driven campaigns and track what drives real growth.",
  },
  {
    image: "/images/selling.png",
    title: "Operations & Scaling",
    units: "20 Units",
    description: "Improve efficiency and scale operations with reliable automations.",
  },
];
...
export default function Operate() {
    ...
    <section className="w-full bg-[#E6E6E6] py-12 md:py-20 md:px-6 lg:px-12">
      <div className="max-w-[96rem] mx-auto px-5">
        ...
        <div className="flex flex-col gap-6">
          ...
          <button className="relative top-6 w-[170px] md:w-[210px] h-[38px] md:h-[47px] lg:h-[53px] bg-black rounded-md text-white hover:bg-black/90 transition">
  ...
  <div className="mt-auto pt-3 text-[14px] font-semibold text-[#2B2B2B]">
    Explore
  </div>
